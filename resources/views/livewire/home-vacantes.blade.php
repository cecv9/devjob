                    ...
                    @forelse ($vacantes as $vacante) 
                        <div class="md:flex md:justify-between md:items-center py-5">
                                        <div class="md:flex-1">
                                                ...
                                                <p class="text-base text-gray-600 mb-3">Empresa : {{$vacante->empresa}} </p>
                                                <p class="text-base text-gray-600 mb-3">Empresa : {{$vacante->categoria->categoria}} </p>
                                                <p class="text-base text-gray-600 mb-3">Empresa : {{$vacante->salario->salario}} </p>
                                                <p>
                                        ...
                                        <div class="mt-5 md:mt-0">
                                            ...
                                            href="{{route('vacantes.show',$vacante->id)}}">Ver la Vacante</a>
                                        </div>
                        </div>
                    @empty
