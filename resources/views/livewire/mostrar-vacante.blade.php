<div class="p-10">
    ...
    <div class="mb-5">
        ...
        <div class="md:grid md:grid-cols-2 bg-gray-50 p-4">
            <p class="font-bold text-sm uppercase text-gray-800 my-3 my-10">
                Empresa :
    ...
    <p>
        Desea aplicar a esta vacante? <a class="font-bold text-indigo-600" href="{{route('register')}}">Obten una cuenta  y aplica a esta vacante y otras vacantes</a>
    </p>
    </div>
    @endguest
